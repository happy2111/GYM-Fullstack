...
const useTranslation = () => {
  ...
  const translations = {
    en: {
      // Headers
      tariffsManagement: 'Tariffs Management',
      manageAllTariffs: 'Manage all gym tariffs and pricing plans',
      ...
      regularTariffs: 'Regular Tariffs',
      ...
      enterCode: 'Enter tariff code',
      enterName: 'Enter tariff name',
      enterDescription: 'Enter description',
      enterPrice: 'Enter price',
      enterDuration: 'Enter duration in days',
      enterMaxVisits: 'Enter max visits (leave empty for unlimited)',
      enterFeatures: 'Enter features (one per line)',
      markAsBestOffer: 'Mark as best offer',

      // Messages
      noTariffsFound: 'No tariffs found',
      tryAdjusting: 'Try adjusting your search filters',
      addFirstTariff: 'Add first tariff',
      confirmDeletion: 'Confirm Deletion',
      deleteTariffConfirm: 'Are you sure you want to delete this tariff? This action cannot be undone.',
    ...
    ru: {
      // Headers
      tariffsManagement: 'Управление тарифами',
      manageAllTariffs: 'Управление всеми тарифами и тарифными планами',
      ...
      isBestOffer: 'Лучшее предложение',
      unlimited: 'Безлимит',
      days: 'дней',
      ...
      enterCode: 'Введите код тарифа',
      enterName: 'Введите название тарифа',
      enterDescription: 'Введите описание',
      enterPrice: 'Введите цену',
      enterDuration: 'Введите длительность в днях',
      enterMaxVisits: 'Введите макс. посещений (пустое = безлимит)',
      enterFeatures: 'Введите особенности (по одной на строку)',
      markAsBestOffer: 'Отметить как лучшее предложение',

      // Messages
      noTariffsFound: 'Тарифы не найдены',
      tryAdjusting: 'Попробуйте изменить фильтры поиска',
      addFirstTariff: 'Добавить первый тариф',
      confirmDeletion: 'Подтвердить удаление',
      deleteTariffConfirm: 'Вы уверены, что хотите удалить этот тариф? Это действие нельзя отменить.',
    ...
    uz: {
      // Headers
      tariffsManagement: 'Tariflarni boshqarish',
      manageAllTariffs: 'Barcha sport zali tariflari va narxlar rejalarini boshqarish',

      // Search and filters
      searchPlaceholder: 'Nom, kod yoki tavsif bo\'yicha qidirish...',
      addTariff: 'Tarif qo\'shish',
      allTypes: 'Barcha turlar',
      bestOffers: 'Eng yaxshi takliflar',
      regularTariffs: 'Oddiy tariflar',
      ...
      description: 'Tavsif',
      priceAmount: 'Narx',
      durationDays: 'Davomiyligi (kunlar)',
      maxVisits: 'Maks. tashriflar',
      featuresLabel: 'Xususiyatlar',
      isBestOffer: 'Eng yaxshi taklif',
      ...
      updateTariff: 'Tarifni yangilash',
      enterCode: 'Tarif kodini kiriting',
      enterName: 'Tarif nomini kiriting',
      enterDescription: 'Tavsifni kiriting',
      enterPrice: 'Narxni kiriting',
      enterDuration: 'Davomiylikni kunlarda kiriting',
      enterMaxVisits: 'Maks. tashriflarni kiriting (bo\'sh = cheklanmagan)',
      enterFeatures: 'Xususiyatlarni kiriting (har birini alohida qatorda)',
      markAsBestOffer: 'Eng yaxshi taklif deb belgilash',

      // Messages
      noTariffsFound: 'Tariflar topilmadi',
      tryAdjusting: 'Qidiruv filtrlarini o\'zgartirishga harakat qiling',
      addFirstTariff: 'Birinchi tarifni qo\'shish',
      confirmDeletion: 'O\'chirishni tasdiqlash',
      deleteTariffConfirm: 'Ushbu tarifni o\'chirishga ishonchingiz komilmi? Bu amalni bekor qilib bo\'lmaydi.',
